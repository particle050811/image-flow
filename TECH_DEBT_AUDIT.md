...
首轮：2026-06-08 · 第二轮：2026-06-09 · 第三轮：2026-06-11 · 第四轮：2026-06-19（聚焦：前端重复造轮子 + 大文件拆分）· 第五轮：2026-06-26（聚焦：round-4 后增量——分辨率档位/收藏控制器/媒体引用重构）· 范围：全仓（src/ ~6,236 LOC，含 webview）

本文件只保留**未终结**的发现（OPEN / PARTIAL / 开放问题）。已修复与已判定可接受的项（F001–F032、F036–F041、F043–F047、F049、F051–F057，共 50+ 项）归档在 [`TECH_DEBT_RESOLVED.md`](TECH_DEBT_RESOLVED.md)，含各轮修复记录。复审时：新发现追加进下表并标 `NEW`，修完移入归档文件。
...
## 当前状态（2026-06-26 第五轮收尾）

- `npm run compile`（check-types + lint + esbuild）全绿；`npm test` 115 项全绿。
- 无 Critical / High 未决项；下表仅余 4 项 Low/Medium：F033（注释口径）+ F048（双窗口边角）等决策，F029/F050 跟踪上游/外部。本轮新增的 F058/F059/F060 已当场修复，F034/F035 + 编辑区清空已按维护者决策落地，均移入归档。
...
> 第四轮 F052–F057、第五轮 F034/F035/F058/F059/F060 均已修复/结案，详见 [`TECH_DEBT_RESOLVED.md`](TECH_DEBT_RESOLVED.md)。
