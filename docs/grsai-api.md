...
**gpt-image-2-vip 比例参考（按比例 + 1K/2K/4K 换算成像素值发送）**
...
| 1:3 | —（官方仅 2 档） | 688x2048 | 1280x3840 |
| 3:1 | —（官方仅 2 档） | 2048x688 | 3840x1280 |
| 2:1 | 1536x768 | 3072x1536 | 3840x1920 |
| 1:2 | 768x1536 | 1536x3072 | 1920x3840 |

> `auto` 不换算，原样发 `"auto"`。`1:3` / `3:1` 官方只给两个像素值（无 1K），上表按长边维度（3840=4K、2048=2K）归档。

**gpt-image-2（非 vip）比例参考（仅 1K；可直接发比例字符串，后端按下表出图）**

| 比例 | 像素 | 比例 | 像素 |
|------|------|------|------|
| 1:1 | 1024x1024 | 5:4 | 1408x1120 |
| 16:9 | 1672x941 | 4:5 | 1120x1408 |
| 9:16 | 941x1672 | 21:9 | 1920x832 |
| 4:3 | 1443x1090 | 9:21 | 832x1920 |
| 3:4 | 1090x1443 | 2:1 | 1792x896 |
| 3:2 | 1536x1024 | 1:2 | 896x1792 |
| 2:3 | 1024x1536 | auto | （自动） |
